...
<header>
	<div class="row">
		...
		<div class="col-sm-6 text-right h2">
	    	...
	    	<a class="btn btn-default" href="tipo-vistoria.php"><i class="fa fa-refresh"></i> Atualizar</a>
	    </div>
	</div>
</header>

<hr>
	<?php $tipovistoria = new tipoVistoria()?>
...
<tbody> 
<?php foreach($tipovistoria->selectAllOrderBy() as $key => $value): ?>
	<tr>
		<td><?php echo $value->tipovistoria; ?></td>
		<td class="actions text-right">
			<a href="#" class="btn btn-sm btn-warning" data-toggle="modal" data-target="#modal-edit" data-id="<?php echo $value->id ?>" data-descricao="<?php echo $value->tipovistoria ?>"><i class="fa fa-pencil"></i> Editar</a>
