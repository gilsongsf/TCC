<?php
	...
	include('tipovistoria-modal.php'); 
...
<header>
	<div class="row">
		...
		<div class="col-sm-6 text-right h2">
	    	...
	    	<a class="btn btn-default" href="tipovistoria-view.php"><i class="fa fa-refresh"></i> Atualizar</a>
	    </div>
	</div>
</header>

<hr>
	<?php $tipovistoria = new tipoVistoriaController()?>
