        ...
        <div class="modal-dialog" role="document">
          <div class="modal-content">
            <div class="modal-header">
              ...
              <h4 class="modal-title text-center" id="ModalLabel">Tipo de Vistoria | CADASTRO</h4>
            </div>
            <div class="modal-body">
              <form method="POST" action="<?php echo CONTROLLERS; ?>cadastro-basico/tipovistoria/tipovistoria-controller.php">
                <div class="row">
                  <div class="form-group col-md-6">
                    <label for="tipovistoria" class="control-label">Descrição:</label>
                    <input name="tipovistoria" type="text" class="form-control" required>
                  </div>
                </div>
                <div class="row">
      ...
      <div class="modal fade" id="modal-edit" tabindex="-1" role="dialog" aria-labelledby="ModalLabel">
        <div class="modal-dialog" role="document">
          <div class="modal-content">
            <div class="modal-header">
              <button type="button" class="close" data-dismiss="modal" aria-label="Close"><span aria-hidden="true">&times;</span></button>
              <h4 class="modal-title text-center" id="ModalLabel">Tipo de Vistoria | EDITAR</h4>
            </div>
            <div class="modal-body">
              <form method="POST" action="<?php echo CONTROLLERS; ?>cadastro-basico/tipovistoria/tipovistoria-controller.php">
                <div class="row">
